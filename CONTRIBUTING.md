...
- **Independently released packages** (`opentelemetry-opamp-client`, `opentelemetry-propagator-aws-xray`, `opentelemetry-resource-detector-azure`, `opentelemetry-resourcedetector-gcp`, `opentelemetry-sdk-extension-aws`, `opentelemetry-instrumentation-valkey`): add to `<package>/.changelog/`
