...
import oxeye_opentelemetry.trace as trace_api
from oxeye_opentelemetry.exporter.datadog.constants import (
...
from oxeye_opentelemetry.sdk.trace import sampling
from oxeye_opentelemetry.sdk.trace.export import SpanExporter, SpanExportResult
from oxeye_opentelemetry.semconv.trace import SpanAttributes
...
_INSTRUMENTATION_SPAN_TYPES = {
    "oxeye_opentelemetry.instrumentation.aiohttp-client": DatadogSpanTypes.HTTP,
    "oxeye_opentelemetry.instrumentation.asgi": DatadogSpanTypes.WEB,
    "oxeye_opentelemetry.instrumentation.dbapi": DatadogSpanTypes.SQL,
    "oxeye_opentelemetry.instrumentation.django": DatadogSpanTypes.WEB,
    "oxeye_opentelemetry.instrumentation.flask": DatadogSpanTypes.WEB,
    "oxeye_opentelemetry.instrumentation.grpc": DatadogSpanTypes.GRPC,
    "oxeye_opentelemetry.instrumentation.jinja2": DatadogSpanTypes.TEMPLATE,
    "oxeye_opentelemetry.instrumentation.mysql": DatadogSpanTypes.SQL,
    "oxeye_opentelemetry.instrumentation.psycopg2": DatadogSpanTypes.SQL,
    "oxeye_opentelemetry.instrumentation.pymemcache": DatadogSpanTypes.CACHE,
    "oxeye_opentelemetry.instrumentation.pymongo": DatadogSpanTypes.MONGODB,
    "oxeye_opentelemetry.instrumentation.pymysql": DatadogSpanTypes.SQL,
    "oxeye_opentelemetry.instrumentation.redis": DatadogSpanTypes.REDIS,
    "oxeye_opentelemetry.instrumentation.requests": DatadogSpanTypes.HTTP,
    "oxeye_opentelemetry.instrumentation.sqlalchemy": DatadogSpanTypes.SQL,
    "oxeye_opentelemetry.instrumentation.wsgi": DatadogSpanTypes.WEB,
}


class DatadogSpanExporter(SpanExporter):
    """Datadog span exporter for oxeye_opentelemetry.
    ...
    def _translate_to_datadog(self, spans):
        ...
        for span in spans:
            ...
            if not span.status.is_ok:
                ...
                # https://github.com/ox-eye/oxeye_opentelemetry-python/blob/71e3a7a192c0fc8a7503fac967ada36a74b79e58/oxeye_opentelemetry-sdk/src/oxeye_opentelemetry/sdk/trace/__init__.py#L810-L819
                if span.events:
