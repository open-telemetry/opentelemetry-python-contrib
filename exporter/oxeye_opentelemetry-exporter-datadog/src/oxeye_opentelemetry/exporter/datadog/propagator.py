...
from oxeye_opentelemetry.exporter.datadog import constants
from oxeye_opentelemetry.propagators.textmap import (
    CarrierT,
    Getter,
    Setter,
    TextMapPropagator,
...
class DatadogFormat(TextMapPropagator):
    ...
    def fields(self):
        ...
        See
        `oxeye_opentelemetry.propagators.textmap.TextMapPropagator.fields`
        """
        return {
            self.TRACE_ID_KEY,
            self.PARENT_ID_KEY,
