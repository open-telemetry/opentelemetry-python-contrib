...
from oxeye_opentelemetry.exporter.datadog import constants, propagator
from oxeye_opentelemetry.sdk import trace
from oxeye_opentelemetry.sdk.trace.id_generator import RandomIdGenerator
from oxeye_opentelemetry.trace import get_current_span, set_span_in_context
...
class TestDatadogFormat(unittest.TestCase):
    ...
    @patch("oxeye_opentelemetry.exporter.datadog.propagator.get_current_span")
