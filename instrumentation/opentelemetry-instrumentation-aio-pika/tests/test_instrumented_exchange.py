...
from .consts import MESSAGING_SYSTEM, SERVER_HOST, SERVER_PORT, MESSAGE_ID, CORRELATION_ID, EXCHANGE_NAME, ROUTING_KEY, MESSAGE, CONNECTION, CHANNEL
...
class TestInstrumentedExchange(TestCase):
    ...
    def _test_publish(self, exchange_type: Type[InstrumentedExchange]):
        ...
        with mock.patch.object(InstrumentedExchange, '_get_publish_span') as mock_get_publish_span:
            with mock.patch.object(Exchange, 'publish', return_value=asyncio.sleep(0)) as mock_publish:
