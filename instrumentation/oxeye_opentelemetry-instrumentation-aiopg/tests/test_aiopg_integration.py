...
import oxeye_opentelemetry.instrumentation.aiopg
from oxeye_opentelemetry import trace as trace_api
from oxeye_opentelemetry.instrumentation.aiopg import AiopgInstrumentor, wrappers
...
class TestAiopgInstrumentor(TestBase):
    ...
    def test_instrumentor_connect(self):
        ...
        self.check_span_instrumentation_info(
            span, oxeye_opentelemetry.instrumentation.aiopg
        )
