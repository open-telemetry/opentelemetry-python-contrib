...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.aiopg import trace_integration
...
from oxeye_opentelemetry.instrumentation.aiopg.aiopg_integration import (
    AiopgIntegration,
    AsyncProxyObject,
    get_traced_connection_proxy,
)
from oxeye_opentelemetry.instrumentation.aiopg.version import __version__
...
def wrap_connect(
    ...
    Args:
        name: Name of oxeye_opentelemetry extension for aiopg.
        database_system: An identifier for the database management system (DBMS)
            product being used.
        connection_attributes: Attribute names for database, port, host and
            user in Connection object.
        version: Version of oxeye_opentelemetry extension for aiopg.
        tracer_provider: The :class:`oxeye_opentelemetry.trace.TracerProvider` to
            use. If omitted the current configured one is used.
    """
