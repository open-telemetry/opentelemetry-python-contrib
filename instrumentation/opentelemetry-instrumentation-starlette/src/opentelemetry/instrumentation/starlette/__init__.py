...
class StarletteInstrumentor(BaseInstrumentor):
    ...
    def instrument_app(
        ...
        if not getattr(app, "_is_instrumented_by_opentelemetry", False):
            ...
            _logger.warning("Attempting to instrument Starlette app while already instrumented")
    ...
    def _uninstrument(self, **kwargs: Any):
        ...
        instances_to_uninstrument = list(_InstrumentedStarlette._instrumented_starlette_apps)
...
class _InstrumentedStarlette(applications.Starlette):
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        StarletteInstrumentor.instrument_app(self, **_InstrumentedStarlette._instrument_kwargs)
