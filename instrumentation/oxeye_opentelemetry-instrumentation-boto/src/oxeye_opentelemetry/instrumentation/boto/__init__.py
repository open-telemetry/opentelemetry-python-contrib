...
``oxeye_opentelemetry-instrument`` executable which will automatically
...
.. code:: python
    ...
    from oxeye_opentelemetry.instrumentation.boto import BotoInstrumentor
    import boto
...
from oxeye_opentelemetry.instrumentation.boto.package import _instruments
from oxeye_opentelemetry.instrumentation.boto.version import __version__
...
from oxeye_opentelemetry.sdk.trace import Resource
...
def flatten_dict(dict_, sep=".", prefix=""):
    ...
    """
    # NOTE: This should probably be in `oxeye_opentelemetry.instrumentation.utils`.
