...
import oxeye_opentelemetry.instrumentation.elasticsearch
from oxeye_opentelemetry import trace
from oxeye_opentelemetry.instrumentation.elasticsearch import (
...
class TestElasticsearchIntegration(TestBase):
    ...
    def test_instrumentor(self, request_mock):
        ...
        # self.check_span_instrumentation_info(span, oxeye_opentelemetry.instrumentation.elasticsearch)
        self.check_span_instrumentation_info(
            span, oxeye_opentelemetry.instrumentation.elasticsearch
        )
