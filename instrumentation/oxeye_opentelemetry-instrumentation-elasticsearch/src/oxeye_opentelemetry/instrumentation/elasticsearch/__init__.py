...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.elasticsearch import ElasticsearchInstrumentor
...
from oxeye_opentelemetry.instrumentation.elasticsearch.package import _instruments
from oxeye_opentelemetry.instrumentation.elasticsearch.version import __version__
