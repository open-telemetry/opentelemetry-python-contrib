...
"""
The oxeye_opentelemetry-instrumentation-asgi package provides an ASGI middleware that can be used
on any ASGI framework (such as Django-channels / Quart) to track requests
timing through oxeye_opentelemetry.
"""
...
from oxeye_opentelemetry.instrumentation.asgi.version import __version__  # noqa
