...
import oxeye_opentelemetry.instrumentation.asgi as otel_asgi
...
from oxeye_opentelemetry.test.asgitestutil import (
    AsgiTestBase,
...
class TestAsgiApplication(AsgiTestBase):
    ...
    def test_basic_asgi_call(self):
        ...
        app = otel_asgi.oxeye_opentelemetryMiddleware(simple_asgi)
        self.seed_app(app)
    ...
    def test_asgi_exc_info(self):
        ...
        app = otel_asgi.oxeye_opentelemetryMiddleware(error_asgi)
        self.seed_app(app)
        self.send_default_request()
        outputs = self.get_all_output()
    ...
    def test_override_span_name(self):
        ...
        app = otel_asgi.oxeye_opentelemetryMiddleware(
