...
.. code:: python
    ...
    import sqlite3
    from oxeye_opentelemetry.instrumentation.sqlite3 import SQLite3Instrumentor
...
from oxeye_opentelemetry.instrumentation.sqlite3.package import _instruments
from oxeye_opentelemetry.instrumentation.sqlite3.version import __version__
