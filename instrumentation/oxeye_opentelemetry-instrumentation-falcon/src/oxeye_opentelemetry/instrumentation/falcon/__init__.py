...
in Falcon applications. In addition to oxeye_opentelemetry-instrumentation-wsgi,
...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.falcon import FalconInstrumentor
...
from oxeye_opentelemetry.instrumentation.falcon.package import _instruments
from oxeye_opentelemetry.instrumentation.falcon.version import __version__
...
from oxeye_opentelemetry.util.http import get_excluded_urls, get_traced_request_attrs

_logger = getLogger(__name__)

_ENVIRON_STARTTIME_KEY = "oxeye_opentelemetry-falcon.starttime_key"
_ENVIRON_SPAN_KEY = "oxeye_opentelemetry-falcon.span_key"
_ENVIRON_ACTIVATION_KEY = "oxeye_opentelemetry-falcon.activation_key"
_ENVIRON_TOKEN = "oxeye_opentelemetry-falcon.token"
_ENVIRON_EXC = "oxeye_opentelemetry-falcon.exc"
