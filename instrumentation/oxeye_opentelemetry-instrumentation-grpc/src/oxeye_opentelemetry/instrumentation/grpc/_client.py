...
"""Implementation of the invocation-side ox-eye interceptor."""
...
from oxeye_opentelemetry.instrumentation.grpc import grpcext
from oxeye_opentelemetry.instrumentation.grpc._utilities import RpcInfo
...
from oxeye_opentelemetry.propagators.textmap import Setter
...
class oxeye_opentelemetryClientInterceptor(
