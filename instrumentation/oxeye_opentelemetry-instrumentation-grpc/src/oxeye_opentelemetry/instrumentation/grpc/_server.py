...
"""
Implementation of the service-side ox-eye interceptor.
"""
...
class _oxeye_opentelemetryServicerContext(grpc.ServicerContext):
...
class oxeye_opentelemetryServerInterceptor(grpc.ServerInterceptor):
    """
    A gRPC server interceptor, to add oxeye_opentelemetry.

    Usage::

        tracer = some oxeye_opentelemetry tracer

        interceptors = [
            oxeye_opentelemetryServerInterceptor(tracer),
        ]
            ...
            def telemetry_interceptor(request_or_iterator, context):
                ...
                with self._set_remote_context(context):
                    with self._start_span(
                        ...
                        # wrap the context
                        context = _oxeye_opentelemetryServicerContext(context, span)
