...
.. code-block:: python
    ...
    from oxeye_opentelemetry.sdk.trace.export import (
        ConsoleSpanExporter,
        SimpleSpanProcessor,
    )
...
.. code-block:: python
    ...
    from oxeye_opentelemetry import trace
    from oxeye_opentelemetry.instrumentation.grpc import GrpcInstrumentorServer
    from oxeye_opentelemetry.sdk.trace import TracerProvider
    from oxeye_opentelemetry.sdk.trace.export import (
        ConsoleSpanExporter,
        SimpleSpanProcessor,
...
:py:class:`~oxeye_opentelemetry.instrumentation.grpc.GrpcInstrumentorServer`:

.. code-block:: python

    from oxeye_opentelemetry.instrumentation.grpc import server_interceptor
...
from oxeye_opentelemetry import trace
from oxeye_opentelemetry.instrumentation.grpc.grpcext import intercept_channel
from oxeye_opentelemetry.instrumentation.grpc.package import _instruments
from oxeye_opentelemetry.instrumentation.grpc.version import __version__
from oxeye_opentelemetry.instrumentation.instrumentor import BaseInstrumentor
from oxeye_opentelemetry.instrumentation.utils import unwrap
...
def client_interceptor(tracer_provider=None):
    ...
    return _client.oxeye_opentelemetryClientInterceptor(tracer)
...
def server_interceptor(tracer_provider=None):
    ...
    return _server.oxeye_opentelemetryServerInterceptor(tracer)
