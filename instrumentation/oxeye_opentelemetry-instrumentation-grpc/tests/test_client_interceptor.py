...
import oxeye_opentelemetry.instrumentation.grpc
from oxeye_opentelemetry import context, trace
from oxeye_opentelemetry.instrumentation.grpc import GrpcInstrumentorClient
from oxeye_opentelemetry.instrumentation.grpc._client import (
    oxeye_opentelemetryClientInterceptor,
)
from oxeye_opentelemetry.instrumentation.grpc.grpcext._interceptor import (
    _UnaryClientInfo,
)
from oxeye_opentelemetry.instrumentation.utils import _SUPPRESS_INSTRUMENTATION_KEY
...
# User defined interceptor. Is used in the tests along with the oxeye_opentelemetry client interceptor.
class Interceptor(
...
class TestClientProto(TestBase):
    def setUp(self):
        ...
        self.server.start()
        # use a user defined interceptor along with the oxeye_opentelemetry client interceptor
    ...
    def test_unary_unary_future(self):
        ...
        self.check_span_instrumentation_info(
            span, oxeye_opentelemetry.instrumentation.grpc
        )
    ...
    def test_client_interceptor_trace_context_propagation(
        ...
        try:
            ...
            interceptor = oxeye_opentelemetryClientInterceptor(
