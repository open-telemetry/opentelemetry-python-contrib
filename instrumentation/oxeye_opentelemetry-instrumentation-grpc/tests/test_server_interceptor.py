...
from oxeye_opentelemetry.instrumentation.grpc import (
    GrpcInstrumentorServer,
    server_interceptor,
)
from oxeye_opentelemetry.sdk import trace as trace_sdk
...
class Testoxeye_opentelemetryServerInterceptor(TestBase):
    ...
    def test_create_two_spans(self):
        ...
        # Check version and name in span's instrumentation info
        self.check_span_instrumentation_info(
            parent_span, oxeye_opentelemetry.instrumentation.grpc
        )
