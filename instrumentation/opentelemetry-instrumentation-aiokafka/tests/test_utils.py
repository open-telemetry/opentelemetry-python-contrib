...
class TestUtils(TestCase):
    ...
    @mock.patch(
        "opentelemetry.instrumentation.aiokafka.utils.KafkaPropertiesExtractor.extract_bootstrap_servers"
    )
    @mock.patch(
        "opentelemetry.instrumentation.aiokafka.utils.KafkaPropertiesExtractor.extract_send_partition"
    )
    ...
    @mock.patch("opentelemetry.instrumentation.aiokafka.utils.KafkaPropertiesExtractor")
