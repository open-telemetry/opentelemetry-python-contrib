...
def _connection_pool_fixture():
    ...
    with Mocketizer():
        Entry.single_register(Entry.GET, _URL, body="Hello!", match_querystring=False)
        yield pool
    URLLib3Instrumentor().uninstrument()


def test_instrumented_urlopen(benchmark, connection_pool: urllib3.HTTPConnectionPool):
    def run():
        Entry.single_register(Entry.GET, _URL, body="Hello!", match_querystring=False)
