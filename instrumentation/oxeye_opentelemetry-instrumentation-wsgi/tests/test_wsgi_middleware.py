...
from oxeye_opentelemetry.sdk.resources import Resource
from oxeye_opentelemetry.semconv.trace import SpanAttributes
from oxeye_opentelemetry.test.test_base import TestBase
from oxeye_opentelemetry.test.wsgitestutil import WsgiTestBase
...
class TestWsgiApplication(WsgiTestBase):
    ...
    def test_basic_wsgi_call(self):
        app = otel_wsgi.oxeye_opentelemetryMiddleware(simple_wsgi)
    ...
    def test_hooks(self):
        ...
        app = otel_wsgi.oxeye_opentelemetryMiddleware(
    ...
    def test_wsgi_not_recording(self):
        ...
        with mock.patch("oxeye_opentelemetry.trace.get_tracer") as tracer:
    ...
    def test_wsgi_iterable(self):
        ...
        app = otel_wsgi.oxeye_opentelemetryMiddleware(iter_wsgi)
        response = app(self.environ, self.start_response)
    ...
    def test_wsgi_generator(self):
        ...
        app = otel_wsgi.oxeye_opentelemetryMiddleware(gen_wsgi)
        response = app(self.environ, self.start_response)
    ...
    def test_wsgi_exc_info(self):
        app = otel_wsgi.oxeye_opentelemetryMiddleware(error_wsgi)
        response = app(self.environ, self.start_response)
        self.validate_response(response, error=ValueError)

    def test_wsgi_internal_error(self):
        app = otel_wsgi.oxeye_opentelemetryMiddleware(error_wsgi_unhandled)
