...
(such as Django / Flask / Web.py) to track requests timing through oxeye_opentelemetry.
...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.wsgi import oxeye_opentelemetryMiddleware

    app = Flask(__name__)
    app.wsgi_app = oxeye_opentelemetryMiddleware(app.wsgi_app)
...
.. code-block:: python
    ...
    if __name__ == "__main__":
        ...
        func = oxeye_opentelemetryMiddleware(func)
...
from oxeye_opentelemetry.instrumentation.utils import http_status_to_status_code
from oxeye_opentelemetry.instrumentation.wsgi.version import __version__
from oxeye_opentelemetry.propagate import extract
from oxeye_opentelemetry.propagators.textmap import Getter
...
class oxeye_opentelemetryMiddleware:
...
# TODO: inherit from oxeye_opentelemetry.instrumentation.propagators.Setter
