...
from oxeye_opentelemetry.instrumentation.tornado import (
    TornadoInstrumentor,
    patch_handler_class,
...
from oxeye_opentelemetry.trace import SpanKind
...
class TornadoTest(AsyncHTTPTestCase, TestBase):
    ...
    def setUp(self):
        ...
        self.exclude_patch = patch(
            "oxeye_opentelemetry.instrumentation.tornado._excluded_urls",
            get_excluded_urls("TORNADO"),
        )
        self.traced_patch = patch(
            "oxeye_opentelemetry.instrumentation.tornado._traced_request_attrs",
