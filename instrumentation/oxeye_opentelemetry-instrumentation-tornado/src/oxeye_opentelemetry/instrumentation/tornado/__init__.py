...
"""
This library uses oxeye_opentelemetry to track web requests in Tornado applications.
...
.. code-block:: python
    ...
    import tornado.web
    from oxeye_opentelemetry.instrumentation.tornado import TornadoInstrumentor
...
from oxeye_opentelemetry.instrumentation.tornado.package import _instruments
from oxeye_opentelemetry.instrumentation.tornado.version import __version__
