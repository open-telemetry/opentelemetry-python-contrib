...
the ``oxeye_opentelemetry-instrument`` executable which will automatically
...
.. code:: python
    ...
    from oxeye_opentelemetry.instrumentation.sqlalchemy import SQLAlchemyInstrumentor
    import sqlalchemy
...
from oxeye_opentelemetry.instrumentation.sqlalchemy.engine import (
    EngineTracer,
    _get_tracer,
    _wrap_create_engine,
)
from oxeye_opentelemetry.instrumentation.sqlalchemy.package import _instruments
