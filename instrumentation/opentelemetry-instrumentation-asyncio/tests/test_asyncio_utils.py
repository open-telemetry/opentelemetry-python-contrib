...
class TestAsyncioToThread(TestCase):
    ...
    def test_separator(self):
        from opentelemetry.instrumentation.asyncio.utils import get_coros_to_trace
        self.assertEqual(
    ...
    def test_future_trace_enabled(self):
        from opentelemetry.instrumentation.asyncio.utils import get_future_trace_enabled
