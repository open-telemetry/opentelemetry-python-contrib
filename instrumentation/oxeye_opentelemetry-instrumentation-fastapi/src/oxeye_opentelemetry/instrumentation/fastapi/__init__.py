...
from oxeye_opentelemetry.instrumentation.asgi.package import _instruments
...
from oxeye_opentelemetry.util.http import get_excluded_urls, parse_excluded_urls
...
class FastAPIInstrumentor(BaseInstrumentor):
    ...
    def instrument_app(
        ...
        if not getattr(app, "_is_instrumented_by_oxeye_opentelemetry", False):
    ...
    def uninstrument_app(app: fastapi.FastAPI):
        app.user_middleware = [
            ...
            if x.cls is not oxeye_opentelemetryMiddleware
        ]
