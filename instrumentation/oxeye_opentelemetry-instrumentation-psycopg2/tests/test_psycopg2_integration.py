...
import oxeye_opentelemetry.instrumentation.psycopg2
...
class TestPostgresqlIntegration(TestBase):
    def setUp(self):
        self.cursor_mock = mock.patch(
            "oxeye_opentelemetry.instrumentation.psycopg2.pg_cursor", MockCursor
        )
    ...
    def test_instrumentor(self):
        ...
        self.check_span_instrumentation_info(
            span, oxeye_opentelemetry.instrumentation.psycopg2
        )
