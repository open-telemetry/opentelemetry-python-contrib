...
.. code-block:: python
    ...
    import psycopg2
    from oxeye_opentelemetry.instrumentation.psycopg2 import Psycopg2Instrumentor
...
from oxeye_opentelemetry.instrumentation import dbapi
from oxeye_opentelemetry.instrumentation.instrumentor import BaseInstrumentor
from oxeye_opentelemetry.instrumentation.psycopg2.package import _instruments
from oxeye_opentelemetry.instrumentation.psycopg2.version import __version__
...
class Psycopg2Instrumentor(BaseInstrumentor):
    ...
    def instrument_connection(connection, tracer_provider=None):
        if not hasattr(connection, "_is_instrumented_by_oxeye_opentelemetry"):
            connection._is_instrumented_by_oxeye_opentelemetry = False

        if not connection._is_instrumented_by_oxeye_opentelemetry:
            setattr(
            ...
            connection._is_instrumented_by_oxeye_opentelemetry = True
        else:
            _logger.warning(
