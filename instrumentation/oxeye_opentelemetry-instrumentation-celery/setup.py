...
VERSION_FILENAME = os.path.join(
    BASE_DIR, "src", "oxeye_opentelemetry", "instrumentation", "celery", "version.py"
)
with open(VERSION_FILENAME) as f:
    exec(f.read(), PACKAGE_INFO)

PACKAGE_FILENAME = os.path.join(
    BASE_DIR, "src", "oxeye_opentelemetry", "instrumentation", "celery", "package.py"
)
...
class JSONMetadataCommand(distutils.cmd.Command):
    ...
    description = (
        "print out package metadata as JSON. This is used by oxeye_opentelemetry dev scripts to ",
