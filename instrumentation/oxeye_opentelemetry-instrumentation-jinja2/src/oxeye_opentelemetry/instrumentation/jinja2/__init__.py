...
The oxeye_opentelemetry ``jinja2`` integration traces templates loading, compilation
and rendering.
...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.jinja2 import Jinja2Instrumentor
...
from oxeye_opentelemetry.instrumentation.jinja2.package import _instruments
from oxeye_opentelemetry.instrumentation.jinja2.version import __version__
