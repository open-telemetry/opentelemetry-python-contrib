...
``oxeye_opentelemetry-instrumentation`` executable which will automatically
...
.. code:: python
    ...
    from oxeye_opentelemetry.instrumentation.redis import RedisInstrumentor
    import redis
...
from oxeye_opentelemetry.instrumentation.redis.package import _instruments
from oxeye_opentelemetry.instrumentation.redis.util import (
    _extract_conn_attributes,
    _format_command_args,
)
from oxeye_opentelemetry.instrumentation.redis.version import __version__
...
def _traced_execute_command(func, instance, args, kwargs):
    tracer = getattr(redis, "_oxeye_opentelemetry_tracer")
