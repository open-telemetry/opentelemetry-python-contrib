...
The oxeye_opentelemetry ``pymemcache`` integration traces pymemcache client operations
...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.pymemcache import PymemcacheInstrumentor
...
from oxeye_opentelemetry.instrumentation.pymemcache.package import _instruments
from oxeye_opentelemetry.instrumentation.pymemcache.version import __version__
from oxeye_opentelemetry.instrumentation.utils import unwrap
from oxeye_opentelemetry.semconv.trace import (
    DbSystemValues,
    NetTransportValues,
    SpanAttributes,
)
