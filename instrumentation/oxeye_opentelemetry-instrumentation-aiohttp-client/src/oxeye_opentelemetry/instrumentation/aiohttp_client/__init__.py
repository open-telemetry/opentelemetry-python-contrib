# Copyright 2020, oxeye_opentelemetry Authors
#
...
"""
The oxeye_opentelemetry-instrumentation-aiohttp-client package allows tracing HTTP
...
.. code:: python
    ...
    import aiohttp
    from oxeye_opentelemetry.instrumentation.aiohttp_client import (
        create_trace_config,
        url_path_span_name
    )
    import yarl
...
from oxeye_opentelemetry import context as context_api
from oxeye_opentelemetry import trace
from oxeye_opentelemetry.instrumentation.aiohttp_client.package import _instruments
from oxeye_opentelemetry.instrumentation.aiohttp_client.version import __version__
...
from oxeye_opentelemetry.trace import SpanKind, TracerProvider, get_tracer
from oxeye_opentelemetry.trace.status import Status, StatusCode
from oxeye_opentelemetry.util.http import remove_url_credentials
...
def create_trace_config(
    ...
    .. code:: python
        ...
        import aiohttp
        from oxeye_opentelemetry.instrumentation.aiohttp_client import create_trace_config
...
def _instrument(
    ...
    def instrumented_init(wrapped, instance, args, kwargs):
        ...
        trace_config._is_instrumented_by_oxeye_opentelemetry = True
...
def _uninstrument_session(client_session: aiohttp.ClientSession):
    ...
    client_session._trace_configs = [
        ...
        if not hasattr(trace_config, "_is_instrumented_by_oxeye_opentelemetry")
    ]
