...
from oxeye_opentelemetry.instrumentation import aiohttp_client
...
class TestAioHttpIntegration(TestBase):
    ...
    def test_not_recording(self):
        ...
        with mock.patch("oxeye_opentelemetry.trace.get_tracer"):
...
class TestLoadingAioHttpInstrumentor(unittest.TestCase):
    def test_loading_instrumentor(self):
        entry_points = iter_entry_points(
            "oxeye_opentelemetry_instrumentor", "aiohttp-client"
        )
