...
- **instrument_producer** (Callable) - a function with extra user-defined logic to be performed before sending
  the message
...
- **instrument_consumer** (Callable) - a function with extra user-defined logic to be performed after consuming
  a message
