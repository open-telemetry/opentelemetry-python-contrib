...
from oxeye_opentelemetry.instrumentation.asyncpg.package import _instruments
from oxeye_opentelemetry.instrumentation.asyncpg.version import __version__
