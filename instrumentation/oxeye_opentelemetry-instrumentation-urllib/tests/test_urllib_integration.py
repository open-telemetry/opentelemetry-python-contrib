...
import oxeye_opentelemetry.instrumentation.urllib  # pylint: disable=no-name-in-module,import-error
from oxeye_opentelemetry import context, trace
from oxeye_opentelemetry.instrumentation.urllib import (  # pylint: disable=no-name-in-module,import-error
    URLLibInstrumentor,
)
...
class RequestsIntegrationTestBase(abc.ABC):
    ...
    def test_basic(self):
        ...
        self.check_span_instrumentation_info(
            span, oxeye_opentelemetry.instrumentation.urllib
        )
