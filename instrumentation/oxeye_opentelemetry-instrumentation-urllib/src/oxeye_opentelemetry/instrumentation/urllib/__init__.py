...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.urllib import URLLibInstrumentor
...
from oxeye_opentelemetry.instrumentation.urllib.package import _instruments
from oxeye_opentelemetry.instrumentation.urllib.version import __version__
...
def _instrument(tracer, span_callback=None, name_callback=None):
    ...
    instrumented_open.oxeye_opentelemetry_instrumentation_urllib_applied = True
...
def _uninstrument_from(instr_root, restore_as_bound_func=False):
    ...
    if not getattr(
        instr_func, "oxeye_opentelemetry_instrumentation_urllib_applied", False,
    ):
        return
