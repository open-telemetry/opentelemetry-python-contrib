...
import oxeye_opentelemetry.instrumentation.httpx
...
from oxeye_opentelemetry.propagate import get_global_textmap, set_global_textmap
from oxeye_opentelemetry.sdk import resources
from oxeye_opentelemetry.semconv.trace import SpanAttributes
from oxeye_opentelemetry.test.mock_textmap import MockTextMapPropagator
from oxeye_opentelemetry.test.test_base import TestBase
from oxeye_opentelemetry.trace import StatusCode
...
if typing.TYPE_CHECKING:
    ...
    from oxeye_opentelemetry.sdk.trace.export import SpanExporter
    from oxeye_opentelemetry.trace import TracerProvider
    ...
    class BaseTest(TestBase, metaclass=abc.ABCMeta):
        ...
        def test_basic(self):
            ...
            self.check_span_instrumentation_info(
                span, oxeye_opentelemetry.instrumentation.httpx
            )
    ...
    class BaseManualTest(BaseTest, metaclass=abc.ABCMeta):
        ...
        def create_client(
            ...
            transport: typing.Union[
                Syncoxeye_opentelemetryTransport, Asyncoxeye_opentelemetryTransport, None
            ] = None,
        ):
            pass
        ...
        def test_not_recording(self):
            with mock.patch("oxeye_opentelemetry.trace.INVALID_SPAN") as mock_span:
                transport = self.create_transport(
...
class TestSyncIntegration(BaseTestCases.BaseManualTest):
    ...
    def create_client(
        self, transport: typing.Optional[Syncoxeye_opentelemetryTransport] = None,
    ):
...
class TestAsyncIntegration(BaseTestCases.BaseManualTest):
    ...
    def create_transport(
        ...
        telemetry_transport = Asyncoxeye_opentelemetryTransport(
            transport,
            tracer_provider=tracer_provider,
            request_hook=request_hook,
            response_hook=response_hook,
    ...
    def create_client(
        self, transport: typing.Optional[Asyncoxeye_opentelemetryTransport] = None,
    ):
