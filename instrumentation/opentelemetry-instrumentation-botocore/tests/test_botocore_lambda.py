...
class TestLambdaExtension(TestBase):
    ...
    @staticmethod
    def _create_extension(operation: str) -> LambdaExtension:
        mock_call_context = mock.MagicMock(operation=operation, params={})
        return LambdaExtension(mock_call_context)
    ...
    def test_invoke_parse_arn(self):
        ...
        arns = (
            "arn:aws:lambda:{}:000000000000:function:{}".format(  # full arn
                self.region, function_name
            ),
            "000000000000:{}".format(function_name),  # partial arn
            "arn:aws:lambda:{}:000000000000:function:{}:alias".format(  # aliased arn
                self.region, function_name
            ),
        )
