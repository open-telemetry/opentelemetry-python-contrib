...
from oxeye_opentelemetry.context import attach, detach
from oxeye_opentelemetry.instrumentation.django.version import __version__
from oxeye_opentelemetry.instrumentation.propagators import (
    get_global_response_propagator,
)
from oxeye_opentelemetry.instrumentation.utils import extract_attributes_from_object
from oxeye_opentelemetry.instrumentation.wsgi import (
...
from oxeye_opentelemetry.trace import Span, SpanKind, use_span
...
class _DjangoMiddleware(MiddlewareMixin):
    """Django Middleware for oxeye_opentelemetry"""

    _environ_activation_key = (
        "oxeye_opentelemetry-instrumentor-django.activation_key"
    )
    _environ_token = "oxeye_opentelemetry-instrumentor-django.token"
    _environ_span_key = "oxeye_opentelemetry-instrumentor-django.span_key"
    _environ_exception_key = "oxeye_opentelemetry-instrumentor-django.exception_key"
    ...
    def process_request(self, request):
        ...
        span = self._tracer.start_span(
            ...
            start_time=request_meta.get(
                "oxeye_opentelemetry-instrumentor-django.starttime_key"
            ),
        )
