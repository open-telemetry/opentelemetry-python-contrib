...
from oxeye_opentelemetry.instrumentation.django import (
    DjangoInstrumentor,
    _DjangoMiddleware,
)
...
from oxeye_opentelemetry.sdk.trace import Span
...
from oxeye_opentelemetry.trace import (
    SpanKind,
    StatusCode,
    format_span_id,
    format_trace_id,
...
class TestMiddleware(TestBase, WsgiTestBase):
    ...
    def setUp(self):
        ...
        self.exclude_patch = patch(
            "oxeye_opentelemetry.instrumentation.django.middleware._DjangoMiddleware._excluded_urls",
            get_excluded_urls("DJANGO"),
        )
        self.traced_patch = patch(
            "oxeye_opentelemetry.instrumentation.django.middleware._DjangoMiddleware._traced_request_attrs",
    ...
    def test_not_recording(self):
        ...
        with patch("oxeye_opentelemetry.trace.get_tracer") as tracer:
