...
def detach_context(task: Task | None, task_id: str, is_publish: bool = False) -> None:
...
def retrieve_context(task: Task | None, task_id: str, is_publish: bool = False) -> ContextTuple | None:
