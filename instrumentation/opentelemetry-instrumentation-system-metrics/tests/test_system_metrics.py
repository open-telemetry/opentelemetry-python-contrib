...
class TestSystemMetrics(TestBase):
    ...
    def test_system_cpu_utilization(self, mock_cpu_times_percent):
        ...
        expected = {
            (("cpu", 1), ("state", "idle"),): Measurement._TYPE(
                min=1.2 / 100,
                max=1.2 / 100,
                sum=1.2 / 100,
                count=1,
            ...
            (("cpu", 1), ("state", "user"),): Measurement._TYPE(
                min=3.4 / 100,
                max=3.4 / 100,
                sum=3.4 / 100,
                count=1,
            ...
            (("cpu", 1), ("state", "system"),): Measurement._TYPE(
                min=5.6 / 100,
                max=5.6 / 100,
                sum=5.6 / 100,
                count=1,
            ...
            (("cpu", 1), ("state", "irq"),): Measurement._TYPE(
                min=7.8 / 100,
                max=7.8 / 100,
                sum=7.8 / 100,
                count=1,
            ...
            (("cpu", 2), ("state", "idle"),): Measurement._TYPE(
                min=1.2 / 100,
                max=1.2 / 100,
                sum=1.2 / 100,
                count=1,
            ...
            (("cpu", 2), ("state", "user"),): Measurement._TYPE(
                min=3.4 / 100,
                max=3.4 / 100,
                sum=3.4 / 100,
                count=1,
            ...
            (("cpu", 2), ("state", "system"),): Measurement._TYPE(
                min=5.6 / 100,
                max=5.6 / 100,
                sum=5.6 / 100,
                count=1,
            ...
            (("cpu", 2), ("state", "irq"),): Measurement._TYPE(
                min=7.8 / 100,
                max=7.8 / 100,
                sum=7.8 / 100,
                count=1,
    ...
    def test_system_memory_usage(self, mock_virtual_memory):
        ...
        expected = {
            (("state", "used"),): Measurement._TYPE(
                min=1, max=1, sum=1, count=1, last=1
            ),
            (("state", "free"),): Measurement._TYPE(
                min=2, max=2, sum=2, count=1, last=2
            ),
            (("state", "cached"),): Measurement._TYPE(
