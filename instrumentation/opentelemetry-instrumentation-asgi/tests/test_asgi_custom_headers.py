...
SERVER_REQUEST_TEST_VALUE = (
    "Custom-Test-Header-1,Custom-Test-Header-2,Custom-Test-Header-3,Regex-Test-Header-.*,Regex-Invalid-Test-Header-.*,"
    ".*my-secret.*,non-utf8-header,Moto-Z²-non-utf8-header-key"
)
SERVER_RESPONSE_TEST_VALUE = (
    "Custom-Test-Header-1,Custom-Test-Header-2,Custom-Test-Header-3,my-custom-regex-header-.*,invalid-regex-header-.*,"
    ".*my-secret.*,non-utf8-header,Moto-Z²-non-utf8-header-key"
)
