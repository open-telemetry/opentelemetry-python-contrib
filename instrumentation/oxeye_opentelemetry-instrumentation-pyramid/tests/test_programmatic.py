...
class TestProgrammatic(InstrumentationTest, TestBase, WsgiTestBase):
    def setUp(self):
        ...
        self.exclude_patch = patch(
            "oxeye_opentelemetry.instrumentation.pyramid.callbacks._excluded_urls",
    ...
    def test_not_recording(self):
        ...
        with patch("oxeye_opentelemetry.trace.get_tracer"):
            self.client.get("/hello/123")
            span_list = self.memory_exporter.get_finished_spans()
    ...
    def test_tween_list(self):
        tween_list = "oxeye_opentelemetry.instrumentation.pyramid.trace_tween_factory\npyramid.tweens.excview_tween_factory"
    ...
    @patch("oxeye_opentelemetry.instrumentation.pyramid.callbacks._logger")
    def test_warnings(self, mock_logger):
        ...
        tween_list = (
            "oxeye_opentelemetry.instrumentation.pyramid.trace_tween_factory"
        )
        config = Configurator(settings={"pyramid.tweens": tween_list})
        self._common_initialization(config)
