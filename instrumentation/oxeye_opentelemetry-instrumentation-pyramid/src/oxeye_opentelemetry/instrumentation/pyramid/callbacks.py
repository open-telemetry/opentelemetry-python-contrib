...
from oxeye_opentelemetry.instrumentation.pyramid.version import __version__
...
TWEEN_NAME = "oxeye_opentelemetry.instrumentation.pyramid.trace_tween_factory"
SETTING_TRACE_ENABLED = "oxeye_opentelemetry-pyramid.trace_enabled"

_ENVIRON_STARTTIME_KEY = "oxeye_opentelemetry-pyramid.starttime_key"
_ENVIRON_SPAN_KEY = "oxeye_opentelemetry-pyramid.span_key"
_ENVIRON_ACTIVATION_KEY = "oxeye_opentelemetry-pyramid.activation_key"
_ENVIRON_ENABLED_KEY = "oxeye_opentelemetry-pyramid.tracing_enabled_key"
_ENVIRON_TOKEN = "oxeye_opentelemetry-pyramid.token"
...
def _before_traversal(event):
    ...
    if enabled is None:
        _logger.warning(
            "oxeye_opentelemetry pyramid tween 'oxeye_opentelemetry.instrumentation.pyramid.trace_tween_factory'"
    ...
    def trace_tween(request):
        ...
        try:
            ...
            if not span and enabled:
                _logger.warning(
                    "Pyramid environ's oxeye_opentelemetry span missing."
                    "If the oxeye_opentelemetry tween was added manually, make sure"
