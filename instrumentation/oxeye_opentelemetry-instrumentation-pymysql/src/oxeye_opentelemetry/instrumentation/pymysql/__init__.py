...
.. code:: python
    ...
    import pymysql
    from oxeye_opentelemetry.instrumentation.pymysql import PyMySQLInstrumentor
...
from oxeye_opentelemetry.instrumentation.pymysql.package import _instruments
from oxeye_opentelemetry.instrumentation.pymysql.version import __version__
