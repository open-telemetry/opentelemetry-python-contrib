...
class PyMySQLInstrumentor(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        ...
        attributes = _DATABASE_SYSTEM.get_connection_attributes(_CONNECTION_ATTRIBUTES)

        createtime_histogram.record(elapsed_time,attributes=attributes)
    ...
    def instrument_connection(connection, tracer_provider=None):
        ...
        pending_requests_updowncounter.add(1)
        pending_requests_updowncounter.subtract(1)
        connectionusage_updowncounter.add(1)
        connectionusage_updowncounter.subtract(1)
