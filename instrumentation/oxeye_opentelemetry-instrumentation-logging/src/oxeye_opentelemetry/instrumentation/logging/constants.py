...
_MODULE_DOC = """
The oxeye_opentelemetry ``logging`` integration automatically injects tracing context into log statements.
...
.. code-block:: python
    ...
    from oxeye_opentelemetry.instrumentation.logging import LoggingInstrumentor
