...
using ``Psycopg3Instrumentor``.

.. _Psycopg: http://initd.org/psycopg/

SQLCOMMENTER
*****************************************
You can optionally configure Psycopg3 instrumentation to enable sqlcommenter which enriches
...
.. code:: python
    ...
    from opentelemetry.instrumentation.psycopg3 import Psycopg3Instrumentor

    Psycopg3Instrumentor().instrument(enable_commenter=True, commenter_options={})
...
For example,
::
Enabling this flag will add psycopg3
...
.. code-block:: python
    ...
    cnx = psycopg3.connect(database='Database')
    cursor = cnx.cursor()
...
from psycopg import Cursor as pg_cursor
from psycopg.sql import Composed  # pylint: disable=no-name-in-module

from opentelemetry.instrumentation import dbapi
from opentelemetry.instrumentation.instrumentor import BaseInstrumentor
from opentelemetry.instrumentation.psycopg3.package import _instruments
from opentelemetry.instrumentation.psycopg3.version import __version__
...
class Psycopg3Instrumentor(BaseInstrumentor):
    ...
    def _uninstrument(self, **kwargs):
        """ "Disable Psycopg3 instrumentation"""
