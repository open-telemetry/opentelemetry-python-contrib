...
import opentelemetry.instrumentation.psycopg3
...
class TestPostgresqlIntegration(TestBase):
    ...
    def tearDown(self):
        ...
        with self.disable_logging():
            Psycopg3Instrumentor().uninstrument()
    ...
    def test_instrumentor(self):
        ...
        self.assertEqualSpanInstrumentationInfo(
            span, opentelemetry.instrumentation.psycopg3
        )
    ...
    def test_custom_tracer_provider(self):
        ...
        Psycopg3Instrumentor().instrument(tracer_provider=tracer_provider)
    ...
    def test_instrument_connection(self):
        ...
        cnx = Psycopg3Instrumentor().instrument_connection(cnx)
        cursor = cnx.cursor()
        cursor.execute(query)
    ...
    def test_uninstrument_connection_with_instrument(self):
        ...
        cnx = Psycopg3Instrumentor().uninstrument_connection(cnx)
        cursor = cnx.cursor()
        cursor.execute(query)
    ...
    def test_uninstrument_connection_with_instrument_connection(self):
        cnx = psycopg.connect(database="test")
        Psycopg3Instrumentor().instrument_connection(cnx)
        query = "SELECT * FROM test"
        cursor = cnx.cursor()
        cursor.execute(query)
    ...
    def test_sqlcommenter_enabled(self, event_mocked):
        cnx = psycopg.connect(database="test")
        Psycopg3Instrumentor().instrument(enable_commenter=True)
        query = "SELECT * FROM test"
        cursor = cnx.cursor()
        cursor.execute(query)
