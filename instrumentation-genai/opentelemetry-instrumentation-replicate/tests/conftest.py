...
"""Unit tests configuration module for the Replicate instrumentation."""
...
def environment():
    """Ensure the SDK can build a client without a real API token."""
    if not os.getenv("REPLICATE_API_TOKEN"):
        os.environ["REPLICATE_API_TOKEN"] = "test_replicate_api_token"


@pytest.fixture
def replicate_client():
    return Client(api_token=os.environ["REPLICATE_API_TOKEN"])
...
def _instrument(
    ...
    *,
    ...
    # This instrumentation only emits telemetry on the experimental path.
