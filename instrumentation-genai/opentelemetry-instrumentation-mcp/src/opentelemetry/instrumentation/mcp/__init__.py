...
Instrumentation for the MCP Python SDK.
...
WRAPPED_METHODS = [
    {
        ...
        "method": "call_tool",
        "wrapper_factory": "create_call_tool_wrapper",
    },
    {
        "module": "mcp.client.session",
        "object": "ClientSession",
        "method": "list_tools",
        "wrapper_factory": "create_list_tools_wrapper",
    },
    {
        "module": "mcp.client.session",
        "object": "ClientSession",
        "method": "list_resources",
        "wrapper_factory": "create_list_resources_wrapper",
    },
    {
        "module": "mcp.client.session",
        "object": "ClientSession",
        "method": "read_resource",
        "wrapper_factory": "create_read_resource_wrapper",
    },
    {
        "module": "mcp.client.session",
        "object": "ClientSession",
        "method": "list_prompts",
        "wrapper_factory": "create_list_prompts_wrapper",
    },
    {
        "module": "mcp.client.session",
        "object": "ClientSession",
        "method": "get_prompt",
        "wrapper_factory": "create_get_prompt_wrapper",
    },
    {
        "module": "mcp.client.session",
        "object": "ClientSession",
        "method": "initialize",
        "wrapper_factory": "create_initialize_wrapper",
    },
]


class MCPInstrumentor(BaseInstrumentor):
    """An instrumentor for the MCP Python SDK.

    This instrumentor will automatically trace MCP client operations.
    """
    ...
    def _instrument(self, **kwargs: Any) -> None:
        ...
        from opentelemetry.instrumentation.mcp import patch
