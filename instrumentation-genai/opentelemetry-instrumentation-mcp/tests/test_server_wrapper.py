...
class MockIncomingRequest:
    ...
    def __init__(self, method="tools/call", has_id=True, has_meta=False):
        self.method = method
...
class MockIncomingNotification:
    ...
    def __init__(self, method="notifications/initialized", has_meta=False):
        self.method = method
        self.params = MagicMock()
        if has_meta:
            self.params.meta = MagicMock()
...
class TestWrapServerHandleRequest(unittest.TestCase):
    ...
    def test_wrap_server_handle_request_no_request(self):
...
class TestWrapServerHandleNotification(unittest.TestCase):
    ...
    def test_wrap_server_handle_notification_no_notification(self):
...
class TestWrapServerMessageHandler(unittest.TestCase):
    ...
    def test_wrap_server_message_handler_no_message(self):
    ...
    def test_wrap_server_message_handler_no_trace_context(
        self, mock_generate_attrs
    ):
        """Test handler works without trace context."""

        async def mock_wrapped(*args, **kwargs):
            return {"result": "success"}

        mock_instance = MagicMock()
        incoming_msg = MockIncomingRequest(has_meta=False)
    ...
    def test_wrap_server_message_handler_error_status(
        ...
        """Test handler propagates exception."""
