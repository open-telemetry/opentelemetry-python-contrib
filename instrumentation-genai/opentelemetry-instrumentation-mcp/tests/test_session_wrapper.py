...
class MockClientRequest:
    def __init__(self, method="test_method", params=None):
        self.method = method
    ...
    def model_validate(cls, data):
        return cls(data.get("method"), data.get("params", {}))


class MockClientNotification:
    def __init__(self, method="test_notification", params=None):
        self.method = method
        self.params = params or {}
...
class TestWrapSessionSend(unittest.TestCase):
    ...
    def test_wrap_session_send_no_message(self):
    ...
    def test_wrap_session_send_client_request(self, mock_generate_attrs):
    ...
    def test_wrap_session_send_client_notification(self, mock_generate_attrs):
    ...
    def test_wrap_session_send_server_request(self, mock_generate_attrs):
    ...
    def test_wrap_session_send_success_status(self, mock_generate_attrs):
        """Test that successful execution completes without error."""
    ...
    def test_wrap_session_send_error_status(self, mock_generate_attrs):
