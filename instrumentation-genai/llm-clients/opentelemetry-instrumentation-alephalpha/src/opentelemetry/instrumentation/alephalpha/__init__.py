...
Instrumentation for the Aleph Alpha Python Client.
...
.. code-block:: python
    ...
    # Use Aleph Alpha client normally
...
WRAPPED_METHODS = [
    {
        "module": "aleph_alpha_client",
        "object": "Client",
        "method": "complete",
        "wrapper_factory": "create_complete_wrapper",
    },
    {
        "module": "aleph_alpha_client",
        "object": "Client",
...
class AlephAlphaInstrumentor(BaseInstrumentor):
    """An instrumentor for Aleph Alpha's Python Client.

    This instrumentor will automatically trace Aleph Alpha API calls.
    """
    ...
    def _instrument(self, **kwargs: Any) -> None:
        ...
        from opentelemetry.instrumentation.alephalpha import patch
        from opentelemetry.instrumentation.alephalpha.utils import Config
    ...
    def _uninstrument(self, **kwargs: Any) -> None:
        """Disable Aleph Alpha instrumentation."""
        import aleph_alpha_client

        for method_info in WRAPPED_METHODS:
            method = method_info["method"]
            try:
                unwrap(aleph_alpha_client.Client, method)
            except Exception:
                pass
