...
class GroqInstrumentor(BaseInstrumentor):
    """An instrumentor for Groq's Python SDK.

    This instrumentor will automatically trace Groq API calls.
    """
    ...
    def _instrument(self, **kwargs: Any) -> None:
        ...
        from opentelemetry.instrumentation.groq import patch
        from opentelemetry.instrumentation.groq.utils import Config
