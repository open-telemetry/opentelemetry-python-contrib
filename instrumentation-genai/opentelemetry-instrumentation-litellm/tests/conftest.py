...
"""Unit tests configuration module for the LiteLLM instrumentation."""
...
def environment():
    """Ensure litellm can build a client without a real API key."""
...
def _instrument(
    ...
    *,
    ...
    # This instrumentation only emits telemetry on the experimental path via
    # the shared util-genai TelemetryHandler.
