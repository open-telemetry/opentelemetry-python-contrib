...
@pytest.mark.vcr()
@pytest.mark.asyncio()
async def test_async_conversations_create(
    span_exporter, log_exporter, async_openai_client, instrument_with_content
):
    conversation = await async_openai_client.conversations.create()
...
@pytest.mark.vcr()
@pytest.mark.asyncio()
async def test_async_conversation_items_list_with_content(
    span_exporter, log_exporter, async_openai_client, instrument_with_content
):
    ...
    items = await async_openai_client.conversations.items.list(conversation_id=conversation.id)
...
@pytest.mark.vcr()
@pytest.mark.asyncio()
async def test_async_conversation_items_list_no_content(
