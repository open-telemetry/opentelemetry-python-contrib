...
def set_tools_attributes(span: Span, kwargs: dict):
    ...
    for i, tool in enumerate(tools):
        ...
        if parameters:
            try:
                span.set_attribute(
                    f"{prefix}.parameters", json.dumps(parameters)
                )
...
def set_request_content_on_span(span: Span, kwargs: dict, capture_content: bool):
...
def set_response_content_on_span(span: Span, result, capture_content: bool):
