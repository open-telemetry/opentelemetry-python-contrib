OpenTelemetry OpenAI Responses API Instrumentation Example
==========================================================

This is an example of how to instrument OpenAI Responses API calls with zero code changes,
...
response ID, token usage, and duration. Metrics capture token usage and
performance data.
...
You should see response output printed while traces and metrics export to your
