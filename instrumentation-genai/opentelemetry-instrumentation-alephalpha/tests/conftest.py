...
"""Unit tests configuration module for the Aleph Alpha instrumentation."""
...
TEST_TOKEN = "test_aleph_alpha_token"
TEST_HOST = "https://api.aleph-alpha.com"
...
def instrument(
    ...
    """Instrument the Aleph Alpha client on the latest experimental semconv path."""
