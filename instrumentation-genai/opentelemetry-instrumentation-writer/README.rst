OpenTelemetry Writer AI Instrumentation
=======================================

|pypi|

.. |pypi| image:: https://badge.fury.io/py/opentelemetry-instrumentation-writer.svg
   :target: https://pypi.org/project/opentelemetry-instrumentation-writer/

This library allows tracing LLM requests and logging of messages made by the
`Writer AI Python API library <https://pypi.org/project/writerai/>`_. It also
...
(``gen_ai.*``), using the ``writer`` value for ``gen_ai.provider.name``.
...
This section describes how to set up Writer AI instrumentation if you're
setting OpenTelemetry up manually.

Instrumenting all clients
*************************

When using the instrumentor, all clients will automatically trace Writer AI
chat and text completions. You can also optionally capture prompts and
...
**Without this setting the Writer AI instrumentation is a no-op** (a legacy
...
.. code-block:: python
    ...
    WriterInstrumentor().uninstrument()

References
----------
* `OpenTelemetry Project <https://opentelemetry.io/>`_
* `Writer AI Python API library <https://pypi.org/project/writerai/>`_
