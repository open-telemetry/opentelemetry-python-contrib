...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch.dict("os.environ", {"OTEL_INSTRUMENTATION_OPENAI_AGENTS_CAPTURE_CONTENT": "true"})
    ...
    @mock.patch.dict("os.environ", {"OTEL_INSTRUMENTATION_OPENAI_AGENTS_CAPTURE_CONTENT": "false"})
    ...
    @mock.patch.dict("os.environ", {"OTEL_INSTRUMENTATION_OPENAI_AGENTS_CAPTURE_METRICS": "true"})
    def test_is_metrics_enabled_true(self):
        """Test is_metrics_enabled returns True when env var is 'true'."""
        result = is_metrics_enabled()
        self.assertTrue(result)

    @mock.patch.dict("os.environ", {"OTEL_INSTRUMENTATION_OPENAI_AGENTS_CAPTURE_METRICS": "false"})
