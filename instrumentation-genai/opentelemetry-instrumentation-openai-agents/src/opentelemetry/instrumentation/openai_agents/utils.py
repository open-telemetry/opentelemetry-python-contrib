...
def is_content_enabled() -> bool:
    """Return True when OpenAI Agents content capture is enabled."""
    return _coerce_bool(
        os.getenv("OTEL_INSTRUMENTATION_OPENAI_AGENTS_CAPTURE_CONTENT"), False
    )


def is_metrics_enabled() -> bool:
    """Return True when OpenAI Agents metrics capture is enabled."""
    return _coerce_bool(
        os.getenv("OTEL_INSTRUMENTATION_OPENAI_AGENTS_CAPTURE_METRICS"), True
    )
