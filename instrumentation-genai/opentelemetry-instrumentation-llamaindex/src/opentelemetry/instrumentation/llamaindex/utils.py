...
"""Utility functions for LlamaIndex instrumentation."""
...
def dont_throw(func: F) -> F:
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        try:
            ...
            logger.debug(
                "LlamaIndex instrumentation failed in %s: %s",
                func.__name__,
...
class LlamaIndexJSONEncoder(json.JSONEncoder):
    """JSON encoder that handles LlamaIndex objects."""

    def default(self, obj: Any) -> Any:
        """Encode LlamaIndex objects to JSON-serializable format."""
        # Handle common LlamaIndex types
