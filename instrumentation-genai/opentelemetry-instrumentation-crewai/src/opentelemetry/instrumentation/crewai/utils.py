...
"""Utility functions for CrewAI instrumentation."""
...
def dont_throw(func: F) -> F:
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        try:
            ...
            logger.debug(
                "CrewAI instrumentation failed in %s: %s",
                func.__name__,
...
class CrewAIJSONEncoder(json.JSONEncoder):
    """JSON encoder that handles CrewAI objects."""

    def default(self, obj: Any) -> Any:
        """Encode CrewAI objects to JSON-serializable format."""
