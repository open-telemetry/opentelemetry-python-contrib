...
Instrumentation for the IBM WatsonX AI SDK.
...
WRAPPED_METHODS = [
    ...
    },
    {
        ...
        "wrapper_factory": "create_generate_text_wrapper",
    },
    {
        "module": "ibm_watsonx_ai.foundation_models",
        "object": "ModelInference",
        "method": "generate_text_stream",
        "wrapper_factory": "create_generate_text_stream_wrapper",
    },
    {
        "module": "ibm_watsonx_ai.foundation_models",
        "object": "ModelInference",
...
class WatsonXInstrumentor(BaseInstrumentor):
    """An instrumentor for IBM WatsonX AI.

    This instrumentor will automatically trace WatsonX API calls.
    """
    ...
    def _instrument(self, **kwargs: Any) -> None:
        """Enable WatsonX instrumentation."""
        from opentelemetry._logs import get_logger
        from opentelemetry.trace import get_tracer

        from opentelemetry.instrumentation.watsonx import patch
        from opentelemetry.instrumentation.watsonx.utils import Config
    ...
    def _uninstrument(self, **kwargs: Any) -> None:
        """Disable WatsonX instrumentation."""
        for method_info in WRAPPED_METHODS:
            module = method_info["module"]
            obj = method_info["object"]
            method = method_info["method"]
