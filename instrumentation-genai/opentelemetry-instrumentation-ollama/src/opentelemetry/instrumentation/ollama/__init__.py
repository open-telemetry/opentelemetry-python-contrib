...
Instrumentation for the Ollama Python SDK.
...
WRAPPED_METHODS = [
    ...
    },
    {
        ...
        "object": "AsyncClient",
        "method": "generate",
        "wrapper_factory": "create_async_generate_wrapper",
    },
]


class OllamaInstrumentor(BaseInstrumentor):
    """An instrumentor for Ollama's Python SDK.

    This instrumentor will automatically trace Ollama API calls.
    """
    ...
    def _instrument(self, **kwargs: Any) -> None:
        """Enable Ollama instrumentation."""
        from opentelemetry._logs import get_logger
        from opentelemetry.trace import get_tracer

        from opentelemetry.instrumentation.ollama import patch
        from opentelemetry.instrumentation.ollama.utils import Config
    ...
    def _uninstrument(self, **kwargs: Any) -> None:
        """Disable Ollama instrumentation."""
        for method_info in WRAPPED_METHODS:
            module = method_info["module"]
            obj = method_info["object"]
            method = method_info["method"]
