...
def semconv_environment():
    """Enable the latest experimental semconv path with content capture."""
...
def fixture_handler(tracer_provider, logger_provider, meter_provider):
    """A TelemetryHandler wired to in-memory exporters for direct wrapper tests."""
