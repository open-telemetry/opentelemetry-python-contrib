...
"""Vendor detection for LangChain LLM providers."""
...
class VendorRule:
    """Rule for detecting LLM vendor from class name.

    Attributes:
        exact_matches: Set of exact class names that match this vendor.
        patterns: List of lowercase patterns to match in class name.
        vendor_name: The canonical vendor name to return.
    """
    ...
    def matches(self, class_name: str) -> bool:
        """Check if a class name matches this vendor rule.

        Args:
            class_name: The class name to check.

        Returns:
            True if the class name matches this vendor.
        """
