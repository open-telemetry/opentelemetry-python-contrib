...
"""Utility functions for Haystack instrumentation."""
...
def dont_throw(func: F) -> F:
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        try:
            ...
            logger.debug(
                "Haystack instrumentation failed in %s: %s",
                func.__name__,
...
class HaystackJSONEncoder(json.JSONEncoder):
    """JSON encoder that handles Haystack objects and dataclasses."""

    def default(self, obj: Any) -> Any:
        """Encode Haystack objects to JSON-serializable format."""
...
def safe_json_serialize(obj: Any) -> str:
    ...
    """
    try:
        return json.dumps(obj, cls=HaystackJSONEncoder, default=str)
    except (TypeError, ValueError):
        return str(obj)


def with_tracer_wrapper(func: Callable[..., Any]) -> Callable[..., Any]:
    """Helper for providing tracer for wrapper functions.

    Args:
        func: The wrapper function to wrap.

    Returns:
        A wrapper that provides tracer context.
    """
