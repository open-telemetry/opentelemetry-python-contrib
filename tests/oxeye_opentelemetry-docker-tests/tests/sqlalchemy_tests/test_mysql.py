...
MYSQL_CONFIG = {
    ...
    "database": os.getenv("TEST_MYSQL_DATABASE", "oxeye_opentelemetry-tests"),
}
...
class MysqlConnectorTestCase(SQLAlchemyTestMixin):
    ...
    VENDOR = "mysql"
    SQL_DB = "oxeye_opentelemetry-tests"
    ENGINE_ARGS = {
    ...
    def test_engine_execute_errors(self):
        ...
        span = spans[0]
        # span fields
        self.assertEqual(span.name, "SELECT oxeye_opentelemetry-tests")
        self.assertEqual(
