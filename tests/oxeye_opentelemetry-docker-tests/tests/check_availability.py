...
MONGODB_DB_NAME = os.getenv("MONGODB_DB_NAME", "oxeye_opentelemetry-tests")
MONGODB_HOST = os.getenv("MONGODB_HOST", "localhost")
MONGODB_PORT = int(os.getenv("MONGODB_PORT", "27017"))
MYSQL_DB_NAME = os.getenv("MYSQL_DB_NAME", "oxeye_opentelemetry-tests")
...
MSSQL_DB_NAME = os.getenv("MSSQL_DB_NAME", "oxeye_opentelemetry-tests")
