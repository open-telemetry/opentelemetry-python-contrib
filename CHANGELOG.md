...
- `opentelemetry-instrumentation-flask`: Align HTTP server metrics initialization with semantic convention helpers to ensure consistent names, units, and descriptions.
