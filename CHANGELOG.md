...
- Fix warning "Attribute 'celery.timelimit' mixes types" when only one of time limits is set
  ([#2025](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/2025))
