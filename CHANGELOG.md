...
- `opentelemetry-instrumentation-dbapi` Respect suppress_instrumentation functionality ([#3459](https://github.com/open-telemetry/opentelemetry-python-contrib/issues/3459))
