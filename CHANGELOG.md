...
- `opentelemetry-instrumentation-asgi` Remove type annotations of OpentelemetryMiddleware.__call__ function to maintain compatibility with Starlette
  ([#2564](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/2564))
