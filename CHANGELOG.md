...
### Changed
- `opentelemetry-instrumentation-botocore` Make botocore instrumentation (mostly) compliant with semantic conventions
  ([#634](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/634))
