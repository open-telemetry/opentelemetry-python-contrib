...
- `opentelemetry-exporter-prometheus-remote-write` Add capability to rely on AWS Prometheus.
  ([#1533](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/1533))
