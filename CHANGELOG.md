...
- `opentelemetry-instrumentation-aws-lambda` Implement new semantic convention opt-in with stable faas semantic conventions
  ([#2356](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/2356))
