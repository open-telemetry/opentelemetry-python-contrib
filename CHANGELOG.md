...
- `opentelemetry-instrumentation-elasticsearch`: Enhance elasticsearch query body sanitization.([#3919](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/3919)) 
