...
- `opentelemetry-instrumentation-httpx`: Record exception on span when an exception is raised
  ([#3914](https://github.com/open-telemetry/opentelemetry-python-contrib/issues/3914))
