...
_AZURE_RESOURCE_GROUP_NAME_RESOURCE_ATTRIBUTE = "azure.resource_group.name"
_DEPLOYMENT_ENVIRONMENT_NAME_RESOURCE_ATTRIBUTE = "deployment.environment.name"
...
_APP_SERVICE_ATTRIBUTE_ENV_VARS = {
    ...
    _DEPLOYMENT_ENVIRONMENT_NAME_RESOURCE_ATTRIBUTE: _WEBSITE_SLOT_NAME,
